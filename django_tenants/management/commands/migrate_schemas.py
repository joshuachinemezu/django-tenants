...
from django_tenants.utils import get_tenant_domain_model, get_public_schema_name, schema_exists, get_tenant_database_alias, \
        ...
        if self.sync_tenant:
            if self.schema_name and self.schema_name != self.PUBLIC_SCHEMA_NAME:
                if not schema_exists(self.schema_name, self.options.get('database', None)):
                    ...
                    tenants = get_tenant_domain_model().objects.only('schema_name', type_field_name)\
                ...
                if has_multi_type_tenants():
                    ...
                    tenants = get_tenant_domain_model().objects.only(
                        'schema_name').exclude(
